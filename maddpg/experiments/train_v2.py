...
def parse_args():
    ...
    # Environment
    parser.add_argument("--scenario", type=str, default="rsrn", help="name of the scenario script")
        ...
        while True:
            ...
            if terminal and (len(episode_rewards) % arglist.save_rate == 0):
                ...
                if num_adversaries == 0 and False:
                    ...
                    pickle.dump(agent_rewards_np, open('rewards_'+ arglist.exp_name +'.pkl', 'wb'))
                    # agent_rewards_np.to_csv('rewards.csv', index=False, header=False)
